    ...
    <section className="py-24 bg-gradient-subtle relative overflow-hidden" id="about">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-40">
        ...
        <div className="absolute bottom-1/3 right-1/5 opacity-8">
          <svg
            className="w-16 h-16 text-gold animate-triangle-pulse"
            viewBox="0 0 24 24"
            fill="currentColor"
        ...
        <div
          className="absolute bottom-20 left-1/3 text-foreground/5 text-3xl font-bold animate-float-slower"
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          <h2 className="text-display text-primary mb-6 font-display text-[48px]">
            The company that puts <span className="text-accent">you first</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="animate-on-load">
              <h3 className="text-headline text-primary mb-4 font-display">
                Most debt companies treat you like a number.
                <br />
            ...
            <div className="animate-on-load space-y-6 text-body text-foreground/80">
              <p>
                ...
                <strong className="text-primary font-semibold">
                  {" "}
                  listens, understands your unique situation, and fights in your corner
                </strong>
              ...
              <p>
                ...
                <strong className="text-accent font-semibold">
                  {" "}
                  better financial future, one realistic step at a time
                </strong>
                .
              </p>
            </div>
          ...
          <div className="animate-on-load">
            <div className="glass-card p-8 rounded-3xl">
              <h4 className="text-xl font-bold text-primary mb-8 font-display text-center">
