  ...
  return (
    <footer className="relative bg-gradient-primary overflow-hidden">
      ...
      <div className="relative max-w-7xl mx-auto px-6 lg:px-8">
        {/* Main Footer Content */}
        <div className="py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-16 animate-fade-in">
            {/* Company Info */}
            <div className="lg:col-span-2 group">
              <div className="mb-10">
                <h3 className="text-3xl font-bold text-gold mb-6 animate-pulse-glow">
                  The Insolvency Guidance Group
                </h3>
                <p className="text-primary-foreground/90 leading-relaxed text-lg mb-8 max-w-2xl">
              ...
              {/* Address */}
              <div className="mb-10">
                <h4 className="text-xl font-semibold text-gold mb-6 flex items-center">
                  <div className="w-8 h-8 rounded-full bg-gold/20 flex items-center justify-center mr-3 group-hover:bg-gold/30 transition-colors duration-300">
                ...
                <div className="glass-card p-6 rounded-xl shadow-elegant hover:shadow-premium transition-all duration-500">
                  <div className="text-primary-foreground/90 leading-relaxed space-y-1 text-base">
              ...
              <div className="space-y-5">
                <div className="flex items-center space-x-4 p-4 rounded-xl glass hover:bg-gold/5 transition-all duration-300 group/contact">
                  <div className="w-8 h-8 rounded-full bg-gold/20 flex items-center justify-center group-hover/contact:bg-gold/30 transition-colors duration-300">
                    <svg className="w-4 h-4 text-gold group-hover/contact:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                    </svg>
                  </div>
                  <span className="text-primary-foreground/90 font-medium">Call us for free advice</span>
                </div>
                ...
                <div className="flex items-center space-x-4 p-4 rounded-xl glass hover:bg-gold/5 transition-all duration-300 group/contact">
                  ...
                  <span className="text-primary-foreground/90 font-medium">Available Monday to Friday, 9am - 6pm</span>
                </div>
              </div>
            </div>
