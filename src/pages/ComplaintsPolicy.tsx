        ...
        <Card className="backdrop-blur-sm bg-card/50 border-border/50">
          ...
          <CardContent className="space-y-4 text-muted-foreground leading-relaxed">
            <p>
              ...
              However, we do understand that sometimes things can go wrong, we welcome your feedback and the opportunity
              to put things right, so we aim to resolve any issues as soon as possible.
            </p>
            <p>
              If something has gone wrong, then please let us know and we can ensure we fully investigate the issue and
              do everything we can to put things right for you. We will keep you up to date as matters progress and you
              can contact us any time should you have any questions.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="backdrop-blur-sm bg-card/50 border-border/50">
          ...
          <CardContent>
            <p className="text-muted-foreground mb-6">
              Whichever way you choose to contact us, we will start our investigations right away. Our contact details
              are:
            </p>
        ...
        <Card className="backdrop-blur-sm bg-card/50 border-border/50">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Your complaint will usually be handled by one of our highly experienced managers in the first instance
                and we will aim to resolve the complaint within three working days. However, if the manager is not able
                to resolve your complaint, we will escalate the matter to our Complaints Team who will formally
                acknowledge your complaint upon receipt and will confirm the contact details of the person investigating
                it.
              </p>
              <p>
                If we are still investigating your complaint after four weeks, we will explain to you the reasons why
                and indicate when you can expect a full and final response.
              </p>
              <p>
                We should have finalised our investigation and issued our final response within a maximum of eight
                weeks. When we have completed our investigation, we will send you a final response. This response will
                detail the investigation and our findings. It will also confirm our conclusions and whether the
                complaint has been upheld, partially upheld, or not upheld. The response will also explain any action
                being taken, or that has been taken, to correct the situation that led you to complain.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="backdrop-blur-sm bg-card/50 border-border/50">
          ...
          <CardContent className="text-muted-foreground leading-relaxed">
            <p>
              ...
              at Peak Insolvency. The IPA promote and maintain high standards throughout the insolvency industry and
              undertake regular monitoring visits to each member to ensure that all Insolvency Practitioners act in line
              with the insolvency rules, relevant legislation, the code of ethics and best practice guidelines.
            </p>
          </CardContent>
        </Card>
        ...
        <Card className="backdrop-blur-sm bg-card/50 border-border/50">
          ...
          <CardContent className="space-y-6">
            <p className="text-muted-foreground">
              If you are dissatisfied with our final response, or we have not been able to resolve your complaint, or
              indeed at any time of the process, you can escalate the complaint to the IPA using the Insolvency
              ...
              <div className="flex items-start gap-4 p-4 rounded-lg bg-muted/50">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Call the Insolvency Service Enquiry Line on <strong>0300 678 0015</strong>
                    <br />
