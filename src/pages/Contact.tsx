      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-muted/30">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            ...
            <p className="text-base sm:text-lg text-muted-foreground max-w-3xl mx-auto px-4">
              We're guided by our core values: <strong className="text-primary">HONESTY - EMPATHY - UNDERSTANDING</strong>
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-muted-foreground">
                Every situation is unique. We listen to your story and create a tailored solution that works for you.
              </p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-muted-foreground">
                We've helped over 12,000 people with £2.4M in debt written off. Your success is our mission.
              </p>
            </div>
            ...
            <div className="text-center p-6 md:col-span-2 lg:col-span-1">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">No Hidden Fees</h3>
              <p className="text-muted-foreground">
                Transparent pricing with no upfront costs. You'll know exactly what you're paying for.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 bg-background">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-base sm:text-lg text-muted-foreground px-4">
              We specialize in debt solutions that work for people across England and Wales
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gradient-subtle rounded-2xl p-6 text-center">
              <h3 className="text-lg font-semibold text-foreground mb-3">Individual Voluntary Arrangements (IVAs)</h3>
              <p className="text-sm text-muted-foreground mb-4">
                A formal agreement to pay back debts over time. Suitable if you have £6,000+ unsecured debt.
              </p>
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>• Freeze interest and charges</li>
                <li>• One affordable monthly payment</li>
                <li>• Write off remaining debt</li>
              </ul>
            </div>

            <div className="bg-gradient-subtle rounded-2xl p-6 text-center">
              <h3 className="text-lg font-semibold text-foreground mb-3">Trust Deeds (Scotland)</h3>
              <p className="text-sm text-muted-foreground mb-4">
                Scottish debt solution similar to IVAs, helping you manage unaffordable debt payments.
              </p>
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>• Protection from creditors</li>
                <li>• Reduced monthly payments</li>
                <li>• Clear path to debt freedom</li>
              </ul>
            </div>

            <div className="bg-gradient-subtle rounded-2xl p-6 text-center">
              <h3 className="text-lg font-semibold text-foreground mb-3">Debt Arrangement Scheme (DAS)</h3>
              <p className="text-sm text-muted-foreground mb-4">
                A way to pay back debts in a manageable way without pressure from creditors.
              </p>
              <ul className="text-sm text-muted-foreground space-y-1">
                <li>• Stop creditor action</li>
