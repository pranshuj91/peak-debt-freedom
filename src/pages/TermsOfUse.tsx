          ...
          <div className="p-6 sm:p-8 lg:p-12">
            <div className="prose prose-lg max-w-none [&>section]:mb-8 sm:[&>section]:mb-12 [&>section>h2]:text-xl sm:[&>section>h2]:text-2xl [&>section>h2]:font-semibold [&>section>h2]:text-foreground [&>section>h2]:mb-4 sm:[&>section>h2]:mb-6 [&>section>h2]:flex [&>section>h2]:items-center [&>section>h2]:gap-3 [&>section>p]:text-muted-foreground [&>section>p]:leading-relaxed [&>section>p]:mb-4 [&>section>p]:text-sm sm:[&>section>p]:text-base [&>section>ul]:text-muted-foreground [&>section>ul]:space-y-2 [&>section>ul>li]:pl-2 [&>section>ul>li]:text-sm sm:[&>section>ul>li]:text-base">
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  The terms and conditions of use set out below apply to the website owned, operated, and controlled by Peak Insolvency at www.theinsolvencyguidancegroup.co.uk ("the Website"). The Website is intended for use by residents of the United Kingdom of Great Britain and Northern Ireland only. By using the Website, users are deemed to have full knowledge of the following terms and conditions and to accept them.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  No part of this Website may be reproduced, transmitted to, or stored on any other website or in any other form of electronic medium without the express written consent of Peak Insolvency.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  Peak Insolvency will use its reasonable endeavours to provide users with a prompt and continuing service. Peak Insolvency does not, however, warrant that the service it provides will continue uninterrupted or without delay or that it will remain unchanged. Peak Insolvency reserves the right to remove access to the Website as and when necessary for the purposes of maintenance and/or amendment of content.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  Whilst Peak Insolvency will use its reasonable endeavours to ensure that the information contained on the Website is correct and reliable, no warranty, either express or implied, is given as to the accuracy or completeness of the information.
                </p>
                <p className="text-muted-foreground mb-4">
                  The Website is intended to provide users with general information relating to Peak Insolvency, its various products and services, and other financial information, which may be of relevance or interest to users. The Website is not intended to provide exhaustive details in respect of any of the issues or matters referred to on it. Information generated via Peak Insolvency Analyser tool on the Website is intended to be considered as a high-level indicator only and should be treated by users as non-binding guidance.
                </p>
                <p className="text-muted-foreground mb-4">
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  Whilst every effort is made to ensure that any enquiries submitted are dealt with promptly, Peak Insolvency cannot guarantee that queries will always be dealt with within the timescale users may require. Peak Insolvency cannot always guarantee complete confidentiality for data transmitted via the internet or other electronic communications and would therefore recommend that users carefully consider sending sensitive information in this way.
                </p>
              </section>
              ...
              <section>
                ...
                <p className="text-muted-foreground mb-4">
                  Peak Insolvency shall not be liable for any third-party claims or losses of any nature, including, but not limited to, loss of profits, indirect or consequential loss or loss due to circumstances beyond its reasonable control. Peak Insolvency does not accept any liability for any acts or omissions resulting from users' decisions or opinions formed based on use of the Website. Peak Insolvency may, at any time, change, modify, add to, or remove, part or all these terms and conditions. Users should therefore check these terms and conditions and the Website content periodically to see if any information has changed.
                </p>
                <p className="text-muted-foreground mb-4">
                  Continued use of this Website following any change in the terms and conditions will be deemed to constitute the users' acceptance of those changes. Peak Insolvency makes every effort to ensure that the information and data contained on the Website is correct. Peak Insolvency, however, accepts no liability and does not guarantee that the information and data provided is up to date, correct and complete. This also applies for all other websites referred to by means of a hyperlink from time to time. Peak Insolvency is not responsible for the contents of such websites reached by means of such a link and reserves the right to modify or supplement the information or data provided without prior notice.
                </p>
              </section>
